package com.sahingroup.config.dbmigrations;
...
public class InitialSetupMigration {
    ...
    private Authority createYoneticiAuthority() {
        Authority yoneticiAuthority = createAuthority(AuthoritiesConstants.YONETICI);
        return yoneticiAuthority;
    }
