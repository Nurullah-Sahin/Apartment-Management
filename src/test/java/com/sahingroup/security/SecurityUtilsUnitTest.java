package com.sahingroup.security;
...
class SecurityUtilsUnitTest {
    ...
    void testAnonymousIsNotAuthenticated() {
        ...
        authorities.add(new SimpleGrantedAuthority(AuthoritiesConstants.YONETICI));
    ...
    void testHasCurrentUserAnyOfAuthorities() {
        ...
        assertThat(SecurityUtils.hasCurrentUserAnyOfAuthorities(AuthoritiesConstants.YONETICI, AuthoritiesConstants.ADMIN)).isFalse();
    }
    ...
    void testHasCurrentUserNoneOfAuthorities() {
        ...
        assertThat(SecurityUtils.hasCurrentUserNoneOfAuthorities(AuthoritiesConstants.YONETICI, AuthoritiesConstants.ADMIN)).isTrue();
    }
}
